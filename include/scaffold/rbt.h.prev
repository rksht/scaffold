...
template <typename K, typename V> RBNode<K, V> *RBT<K, V>::get_node(const K &key) {
    auto cur = _root;
    while (cur != nil_node()) {
        if (cur->_key == key) {
            return cur;
...
template <typename K, typename V> const RBNode<K, V> *RBT<K, V>::get_node(const K &key) const {
    auto cur = _root;
    while (cur != nil_node()) {
        if (cur->_key == key) {
            return cur;
...
template <typename K, typename V> RBNode<K, V> *RBT<K, V>::remove(RBNode<K, V> *n) {
    auto y = n;
